    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a href="{{route('admin.index')}}"><i class="fa fa-star"></i><span class="hide-menu">Admins </span></a>
                </li>
                @endif
                ...
                @if(Auth::check() && Auth::user()->role == '1')
                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-newspaper-o"></i><span class="hide-menu">Subscriptions  <span class="label label-rouded label-primary pull-right">2</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('subscriptions.create')}}">Create Subscription</a></li>
